...
const SelectDateFilter = (itemMenu: IItemDropDown[]) => {
  return (
    <Dropdows
      children={
        <div className=" flex items-center gap-1 p-2 md:p-3 max-h-[40px] md:gap-2 rounded-[8px] border-[0.5px] !border-gray-custom/50">
          <CiCalendar />
          <p className="!text-xs md:!text-base !font-normal !text-black-custom/70 text-nowrap">
            Quy nay
          </p>
